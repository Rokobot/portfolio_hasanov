                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      _buildSkillCard("Firebase", Icons.cloud, appProvider.isDarkMode),
                      _buildSkillCard("REST API", Icons.api, appProvider.isDarkMode),
                      _buildSkillCard("Provider", Icons.settings, appProvider.isDarkMode),
                      _buildSkillCard("Git", Icons.source, appProvider.isDarkMode),
                      _buildSkillCard("SQL", Icons.storage, appProvider.isDarkMode),
                      _buildSkillCard("AWS", Icons.cloud_queue, appProvider.isDarkMode),
                    ],
                  ),
                ],
              ),
